...
public class GameControl5 : MonoBehaviour {
    ...
    { 
        ...
        if(niv==1)
        {
            spriter.sprite = Resources.Load<Sprite>("Sprites/triangulo/triangulo1");
            //spriter.sprite=imgs.sprite.name("3");
            
            btns[0].GetComponentInChildren<Text>().text = "32";
            btns[1].GetComponentInChildren<Text>().text = "66";
        ...
        {
            spriter.sprite = Resources.Load<Sprite>("Sprites/triangulo/triangulo2");

            btns[0].GetComponentInChildren<Text>().text = "6";
            btns[1].GetComponentInChildren<Text>().text = "8";
            btns[2].GetComponentInChildren<Text>().text = "4";
            btns[3].GetComponentInChildren<Text>().text = "10";
    ...
    public void PasarNivelJuego(int nivel)
    {
        ...
        if(nivel==2)
        {
            SceneManager.LoadScene("Scene5_niv2");
        }
        else
        {
            menu_fin.SetActive(true);
